...
module.exports = {
  head: {
    ...
    link: [{ rel: 'icon', type: 'image/x-icon', href: '/icon.png' }, { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,400italic' }, { rel: 'stylesheet', href: 'https://fonts.googleapis.com/icon?family=Material+Icons' }]
  },
  css: ['~assets/css/main.css', 'muse-ui/dist/muse-ui.css', 'muse-ui/dist/theme-carbon.css'],
  loading: {
    color: '#ff4081'
  },
  modules: ['@nuxtjs/axios', '@nuxtjs/pwa', '@nuxtjs/component-cache'],
  axios: {
    baseURL: 'https://proxy-enldkdbkkm.now.sh',
    credentials: false,
    proxyHeaders: false
  },
...
// Start nuxt.js
var start = function () {
  var _ref = _asyncToGenerator(__WEBPACK_IMPORTED_MODULE_0__Users_uniqueway_github_nuxt_v2ex_node_modules_babel_runtime_regenerator___default.a.mark(function _callee2() {
    var _this = this;
    ...
    return __WEBPACK_IMPORTED_MODULE_0__Users_uniqueway_github_nuxt_v2ex_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 11:
            _context2.prev = 11;
            _context2.t0 // eslint-disable-line no-console
            = _context2['catch'](6);

            console.error(_context2.t0);process.exit(1);

          case 15:

            app.use(function () {
              var _ref2 = _asyncToGenerator(__WEBPACK_IMPORTED_MODULE_0__Users_uniqueway_github_nuxt_v2ex_node_modules_babel_runtime_regenerator___default.a.mark(function _callee(ctx, next) {
